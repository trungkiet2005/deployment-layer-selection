...
The extreme point of the retaliation axis is a grim trigger $\mathsf{GRIM}$,
...
substitution is strongly in favour of the conditional design. What the
$\sigma$-criterion cannot settle is the valley, because it orders each pair of
...
level $r$~\citep{grafen1979hawk,bergstrom2003algebra} a design meets a copy of
...
liability, and none of the ratios in this paper move. What is not free is
...
measuring severity, which inverts the usual emphasis.
