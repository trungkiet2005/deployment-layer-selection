...
system that plays. Whether the agent's \emph{design} -- its model,
...
informally~\citep{hendrycks2023natural,bengio2024managing} and appears as one
of seven risk factors in a recent multi-agent risk
taxonomy~\citep{hammond2025multiagent}, but we are not aware of a formal
treatment.
...
reward speed over quality and can dissipate the rents they
...
own~\citep{cave2018race}.~\citet{armstrong2016precipice} introduced a formal
race model in which
...
extended the analysis to heterogeneous populations; see~\citet{han2022emergent}
...
ones rather than the strict~\citep{molander1985optimal,fudenberg2012slow},
...
care~\citep{shavell1980strict,shavell1984model,shavell1982insurance}; the
same apparatus has recently been brought to bear on harms caused by AI
systems specifically~\citep{buiten2023liability}. All of these analyses are
equilibrium
...
ones~\citep{molander1985optimal,fudenberg2012slow}; what is new here is that
...
measuring severity, which inverts the usual emphasis. It is also actionable
...
agents~\citep{euaiact2024,buiten2023liability}.
